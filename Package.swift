...
let package = Package(
    ...
    dependencies:[
        .package(url:"https://github.com/that-scalcucci-guy/material-text-accessibility-ios", from: "2.0.0"),
        .package(url:"https://github.com/that-scalcucci-guy/material-internationalization-ios", from: "2.0.0")
    ],
    targets: [
